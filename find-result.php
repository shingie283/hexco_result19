...
<html lang="en">
    <head>
        ...
        <title>HEXCO Result Management System</title>
                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    ...
                                    <h4>Higher Education Examination Council(HEXCO)</h4>
                            ...
                            <div class="panel-body p-20">
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="CandidateNo">CANDIDATE No</label>
                                        <input type="text" class="form-control" id="candidateno" placeholder="Enter Your Candidate No" autocomplete="off" name="candidateno">
                                	</div>
